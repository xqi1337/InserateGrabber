        ...
        try:
            ...
            if self.config["Grabber"]["fwready"]:
                with open(inseratpath + "/fwimport.txt", "w") as insifile:
                    insifile.write(f"{inserat['inseratlink']}\n{datum}\n{inserat['title']}\n{inserat['price']}\n{inserat['description']}")
    ...
    def harvestads(self, keyword):
        ...
        while page <= max_pages:
            ...
            try:
                ...
                ebay_items = [
                    item for item in all_items if "amazon" not in item.attributes.get(
                        "class",
                        ""
                    )
                ]
                            ...
                            try:
                                ...
                                if inserat["inseratlink"]:
                                    ...
                                    if self.writeinserat(inserat, inseratpath):
                                        print(f"[{colorama.Fore.RED}+{colorama.Fore.RESET}] {inserat['title']}")
                                    else:
                                        print(f"[{colorama.Fore.YELLOW}!{colorama.Fore.RESET}] Failed to write {inserat['title']}")
                                else:
                                    print(f"[{colorama.Fore.YELLOW}!{colorama.Fore.RESET}] Could not get link for {inserat['title']}")
